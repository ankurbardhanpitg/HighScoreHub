...
- Flappy Bird
- Dino Runner (jump over cacti, flap past pterodactyls, beat 5 levels)
- Chase (grab the stars, dodge the chasers, beat 10 levels)
...
- `POST /api/scores` — body `{ "score": 12, "game": "flappy" }`, requires a signed-in user. The player name is taken from the account username. `game` can be `"flappy"`, `"dino"`, `"chase"`, `"2048"`, `"whack"`, `"pong"`, `"breakout"`, `"starwaves"`, `"bubble"`, `"snake"`, `"tictactoe"`, `"connectfour"`, `"chess"`, `"ludo"`, `"towerdefense"`, or `"simon"` and defaults to `"flappy"`.
