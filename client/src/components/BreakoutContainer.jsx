...
import BreakoutScene, { GAME_HEIGHT, GAME_WIDTH } from '../game/BreakoutScene.js';

const BreakoutContainer = forwardRef(function BreakoutContainer({ onGameOver, onStateChange }, ref) {
  ...
  return <div ref={containerRef} className="game-canvas breakout-canvas" />;
});
