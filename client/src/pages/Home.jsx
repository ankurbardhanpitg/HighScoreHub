    ...
    <>
      <section className="hero">
        <div>
          ...
          <p className="lede">
            Play fun games, save your scores, and climb the leaderboard. Flappy Bird, 2048, Whack-a-Mole, Pong, Breakout, Star Waves, Bubble Shooter, and Snake are ready to play.
          </p>
          {user ? (
