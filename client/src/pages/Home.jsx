    ...
    <>
      <section className="hero">
        <div>
          ...
          <p className="lede">
            Play fun games, save your scores, and climb the leaderboard. Flappy Bird, Dino Runner, Chase, 2048, Whack-a-Mole, Pong, Breakout, Star Waves, Bubble Shooter, Snake, Tic Tac Toe, Connect Four, and Simon Says are ready to play.
          </p>
          {user ? (
